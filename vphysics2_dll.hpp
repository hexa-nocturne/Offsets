...
namespace sdk::vphysics2 {
    ...
    public:
        ...
        SCHEMA_FIELD(CUtlVector<FeAntiTunnelProbe_t> , m_AntiTunnelProbes                              , 0x1B0) // CUtlVector<FeAntiTunnelProbe_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_AntiTunnelTargetNodes                         , 0x1C8) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeNodeStrayBox_t>    , m_NodeStrayBoxes                                , 0x1E0) // CUtlVector<FeNodeStrayBox_t>
        SCHEMA_FIELD(CUtlVector<FeAxialEdgeBend_t>   , m_AxialEdges                                    , 0x1F8) // CUtlVector<FeAxialEdgeBend_t>
        SCHEMA_FIELD(CUtlVector<float32>             , m_NodeInvMasses                                 , 0x210) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<FeCtrlOffset_t>      , m_CtrlOffsets                                   , 0x228) // CUtlVector<FeCtrlOffset_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlOsOffset_t>    , m_CtrlOsOffsets                                 , 0x240) // CUtlVector<FeCtrlOsOffset_t>
        SCHEMA_FIELD(CUtlVector<FeFollowNode_t>      , m_FollowNodes                                   , 0x258) // CUtlVector<FeFollowNode_t>
        SCHEMA_FIELD(CUtlVector<FeCollisionPlane_t>  , m_CollisionPlanes                               , 0x270) // CUtlVector<FeCollisionPlane_t>
        SCHEMA_FIELD(CUtlVector<FeNodeIntegrator_t>  , m_NodeIntegrator                                , 0x288) // CUtlVector<FeNodeIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeSpringIntegrator_t>, m_SpringIntegrator                              , 0x2A0) // CUtlVector<FeSpringIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeSimdSpringIntegrator_t>, m_SimdSpringIntegrator                          , 0x2B8) // CUtlVector<FeSimdSpringIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeWorldCollisionParams_t>, m_WorldCollisionParams                          , 0x2D0) // CUtlVector<FeWorldCollisionParams_t>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LegacyStretchForce                            , 0x2E8) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_NodeCollisionRadii                            , 0x300) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_DynNodeFriction                               , 0x318) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LocalRotation                                 , 0x330) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LocalForce                                    , 0x348) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<FeTaperedCapsuleStretch_t>, m_TaperedCapsuleStretches                       , 0x360) // CUtlVector<FeTaperedCapsuleStretch_t>
        SCHEMA_FIELD(CUtlVector<FeTaperedCapsuleRigid_t>, m_TaperedCapsuleRigids                          , 0x378) // CUtlVector<FeTaperedCapsuleRigid_t>
        SCHEMA_FIELD(CUtlVector<FeSphereRigid_t>     , m_SphereRigids                                  , 0x390) // CUtlVector<FeSphereRigid_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_WorldCollisionNodes                           , 0x3A8) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_TreeParents                                   , 0x3C0) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_TreeCollisionMasks                            , 0x3D8) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeTreeChildren_t>    , m_TreeChildren                                  , 0x3F0) // CUtlVector<FeTreeChildren_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_FreeNodes                                     , 0x408) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeFitMatrix_t>       , m_FitMatrices                                   , 0x420) // CUtlVector<FeFitMatrix_t>
        SCHEMA_FIELD(CUtlVector<FeFitWeight_t>       , m_FitWeights                                    , 0x438) // CUtlVector<FeFitWeight_t>
        SCHEMA_FIELD(CUtlVector<FeNodeReverseOffset_t>, m_ReverseOffsets                                , 0x450) // CUtlVector<FeNodeReverseOffset_t>
        SCHEMA_FIELD(CUtlVector<FeAnimStrayRadius_t> , m_AnimStrayRadii                                , 0x468) // CUtlVector<FeAnimStrayRadius_t>
        SCHEMA_FIELD(CUtlVector<FeSimdAnimStrayRadius_t>, m_SimdAnimStrayRadii                            , 0x480) // CUtlVector<FeSimdAnimStrayRadius_t>
        SCHEMA_FIELD(CUtlVector<FeKelagerBend2_t>    , m_KelagerBends                                  , 0x498) // CUtlVector<FeKelagerBend2_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlSoftOffset_t>  , m_CtrlSoftOffsets                               , 0x4B0) // CUtlVector<FeCtrlSoftOffset_t>
        SCHEMA_FIELD(CUtlVector<CFeIndexedJiggleBone>, m_JiggleBones                                   , 0x4C8) // CUtlVector<CFeIndexedJiggleBone>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_SourceElems                                   , 0x4E0) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint32>              , m_GoalDampedSpringIntegrators                   , 0x4F8) // CUtlVector<uint32>
        SCHEMA_FIELD(CUtlVector<FeTri_t>             , m_Tris                                          , 0x510) // CUtlVector<FeTri_t>
        SCHEMA_FIELD(std::uint16_t                   , m_nTriCount1                                    , 0x528) // uint16
        SCHEMA_FIELD(std::uint16_t                   , m_nTriCount2                                    , 0x52A) // uint16
        SCHEMA_FIELD(std::uint8_t                    , m_nReservedUint8                                , 0x52C) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraPressureIterations                      , 0x52D) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraGoalIterations                          , 0x52E) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraIterations                              , 0x52F) // uint8
        SCHEMA_FIELD(CUtlVector<FeSDFRigid_t>        , m_SDFRigids                                     , 0x530) // CUtlVector<FeSDFRigid_t>
        SCHEMA_FIELD(CUtlVector<FeBoxRigid_t>        , m_BoxRigids                                     , 0x548) // CUtlVector<FeBoxRigid_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_DynNodeVertexSet                              , 0x560) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<uint32>              , m_VertexSetNames                                , 0x578) // CUtlVector<uint32>
        SCHEMA_FIELD(CUtlVector<FeRigidColliderIndices_t>, m_RigidColliderPriorities                       , 0x590) // CUtlVector<FeRigidColliderIndices_t>
        SCHEMA_FIELD(CUtlVector<FeMorphLayerDepr_t>  , m_MorphLayers                                   , 0x5A8) // CUtlVector<FeMorphLayerDepr_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_MorphSetData                                  , 0x5C0) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<FeVertexMapDesc_t>   , m_VertexMaps                                    , 0x5D8) // CUtlVector<FeVertexMapDesc_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_VertexMapValues                               , 0x5F0) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<FeEffectDesc_t>      , m_Effects                                       , 0x608) // CUtlVector<FeEffectDesc_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlOffset_t>      , m_LockToParent                                  , 0x620) // CUtlVector<FeCtrlOffset_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_LockToGoal                                    , 0x638) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<int16>               , m_SkelParents                                   , 0x650) // CUtlVector<int16>
        SCHEMA_FIELD(CUtlVector<FeNodeWindBase_t>    , m_DynNodeWindBases                              , 0x668) // CUtlVector<FeNodeWindBase_t>
        SCHEMA_FIELD(CUtlVector<FeModelSelfCollisionLayer_t>, m_SelfCollisionLayers                           , 0x680) // CUtlVector<FeModelSelfCollisionLayer_t>
        SCHEMA_FIELD(float                           , m_flInternalPressure                            , 0x698) // float32
        SCHEMA_FIELD(float                           , m_flDefaultTimeDilation                         , 0x69C) // float32
        SCHEMA_FIELD(float                           , m_flWindage                                     , 0x6A0) // float32
        SCHEMA_FIELD(float                           , m_flWindDrag                                    , 0x6A4) // float32
        SCHEMA_FIELD(float                           , m_flDefaultSurfaceStretch                       , 0x6A8) // float32
        SCHEMA_FIELD(float                           , m_flDefaultThreadStretch                        , 0x6AC) // float32
        SCHEMA_FIELD(float                           , m_flDefaultGravityScale                         , 0x6B0) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVelAirDrag                           , 0x6B4) // float32
        SCHEMA_FIELD(float                           , m_flDefaultExpAirDrag                           , 0x6B8) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVelQuadAirDrag                       , 0x6BC) // float32
        SCHEMA_FIELD(float                           , m_flDefaultExpQuadAirDrag                       , 0x6C0) // float32
        SCHEMA_FIELD(float                           , m_flRodVelocitySmoothRate                       , 0x6C4) // float32
        SCHEMA_FIELD(float                           , m_flQuadVelocitySmoothRate                      , 0x6C8) // float32
        SCHEMA_FIELD(float                           , m_flAddWorldCollisionRadius                     , 0x6CC) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVolumetricSolveAmount                , 0x6D0) // float32
        SCHEMA_FIELD(float                           , m_flMotionSmoothCDT                             , 0x6D4) // float32
        SCHEMA_FIELD(float                           , m_flLocalDrag1                                  , 0x6D8) // float32
        SCHEMA_FIELD(std::uint16_t                   , m_nRodVelocitySmoothIterations                  , 0x6DC) // uint16
